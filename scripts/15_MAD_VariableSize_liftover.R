...
aa2= aa[aa%in%c( "MAD_dMDA_101_5Mb_lift.rds",
                 "MAD_Pico_76_250kb_lift.rds",
                 "MAD_Pico_101_250kb_lift.rds",
                 "MAD_PTA_48_500kb_lift.rds", 
                 "MAD_PTA_101_500kb_lift.rds")]
...
saveRDS(all2x, file='./data/processed/rds/MAD_VariableSize_liftover.rds')