...
msa= SignificantCNVs[SignificantCNVs$Samples%in%c( "MSA-1","MSA-2"),]
########################################
ensembl = useEnsembl(biomart="ensembl", dataset="hsapiens_gene_ensembl")
genes_df <- getBM(attributes=c('ensembl_gene_id','hgnc_symbol','chromosome_name','start_position','end_position'), mart = ensembl)
...
write.table(unique_ids, file = "./data/processed/txt/MSA.txt", sep = "\t", quote=F,
