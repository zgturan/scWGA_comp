...
pdf( file="./results/MSA_Brain_BP_Revigo_Main.pdf", width=10, height=7) # width and height are in inches
treemap(
  stuff,
...
png( file="./results/MSA_Brain_BP_Revigo_Main.png", width=1600, height=900) # width and height are in inches
treemap(
  stuff,
  index = "representative",
  vSize = "value",
