...
aa= grep("ConfiScore",list.files(), val=T)
aa2= aa[aa%in%c("dMDA_101_5Mb_ConfiScore.rds",
                "Pico_76_250kb_ConfiScore.rds", 
                "Pico_101_250kb_ConfiScore.rds",
...
saveRDS(all2x, file='./data/processed/rds/Confid_VariableSize_hg38.rds')